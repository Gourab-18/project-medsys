...
function EditProfile() {
  ...
  return (
    <div className="flex flex-col space-y-4  ">
        ...
        <div className=" flex flex-col text-gray-600 py-1 grid-row">
          <label className="text-lg">Address</label>
            ...
            <div className="w-full px-3">
                <input
                    className="rounded-sm bg-gray-200 mt-2 p-1 focus:border-yellow-300 focus:bg-white focus:outline-none w-4/5 sm:w-3/4 text-sm"
                    type="text" placeholder="Street Address Line 1"
                />
          </div>
          <div className="w-full px-3">
                <input
                    className="rounded-sm bg-gray-200 mt-2 p-1 focus:border-yellow-300 focus:bg-white focus:outline-none w-4/5 sm:w-3/4 text-sm"
                    type="text" placeholder="Street Address Line 2"
                />
          </div>
      ...
      <div className="mt-7">
      <button className='w-3/4 sm:w-1/2 py-2 bg-mainColor text-rose-100 font-semibold rounded-md hover:bg-rose-900'>Generate Quotation</button>
      </div>

      <div className="mt-7">
      <button className='w-3/4 sm:w-1/2 py-2 bg-mainColor text-rose-100 font-semibold rounded-md hover:bg-rose-900'>Download Quotation</button>
      </div>
